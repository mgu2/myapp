...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'joins_join', 'friend',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='referal', null=True, to=orm['joins.Join']),
                      keep_default=False)
    ...
    models = {
        u'joins.join': {
            ...
            'friend': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'referal'", 'null': 'True', 'to': u"orm['joins.Join']"}),
